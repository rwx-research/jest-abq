...
# <<<<<<< HEAD:website/versioned_docs/version-29.0/Configuration.md
...
> > > > > > > v29.7.0:website/versioned_docs/version-29.6/Configuration.md These options can also be passed in a docblock, similar to `testEnvironment`. The string with options must be parseable by `JSON.parse`:
